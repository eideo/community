...
import cn.usfor.entity.User;
import cn.usfor.service.UserService;
...
public class UserRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        System.out.println((String)token.getCredentials()+"========");
//        if(!user.getPassword().equals((String)token.getCredentials())){

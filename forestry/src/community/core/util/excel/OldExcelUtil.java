package com.hadoop.utils.excel;
 ...
 */
/**
 * @description:you need prepare these jar file for use this ExcelUtil.class
 * dom4j.jar 
 * log4j-1.2.13.jar
 ...
 * 
 * @url:http://blog.csdn.net/xiaoxian8023/article/details/40597835
 */
...
public class OldExcelUtil {	
	...
	public OldExcelUtil(String excelPath){
	 ...
	 * @return
	 */
	public OldExcelUtil RestoreSettings(){
		OldExcelUtil instance = new  OldExcelUtil(this.excelPath);
		return instance;
	}
